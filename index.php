...
<?php
  ...
  $faqs = [
    [
      'question' => "<h2 class='m-top'>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h2>",
    ...
    [
      ...
      <ol>
        <li><span>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:</span>
          <ol class='inside'>
            <li><span>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</span></li>
            <li><span>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</span></li>
          </ol></li><li><span>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</span></li>
...
?>
  ...
  <div class="container">
      ...
      <?php
        ...
        foreach ($faqs as $faq) {
          echo $faq['question'];
          // la funzione nl2br inserisce interruzioni di riga html
          // prima di tutte le nuove righe in una stringa 
          echo nl2br($faq['answer']); 
        }
  ...
  <footer>
    ...
    <div class="language-section">
      ...
      <select name="language" id="lang">
        ...
        <option value="de">Deuthsch</option>
